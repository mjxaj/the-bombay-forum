      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            {/* Featured Article */}
            {featuredArticle && (
              <Link href={`/view/${featuredArticle.articleId}`} className="group block mb-12">
                <Card className="overflow-hidden border-none shadow-none hover:bg-accent/5 transition-all duration-300">
                  <div className="relative aspect-[16/9] mb-6 rounded-xl overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                      <Badge variant="outline" className="mb-4 bg-black/20 backdrop-blur-sm border-white/20 text-white">
                        Featured
                      </Badge>
                ...
                >
                  <Card className="overflow-hidden hover:bg-accent/5 transition-all duration-300">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="font-serif text-xl font-semibold mb-3 group-hover:text-primary/80 transition-colors line-clamp-2">
                        {article.title}
                      </h3>
                      {article.description && (
                  ...
                  <Card className="overflow-hidden hover:bg-accent/5 transition-all duration-300">
                    <div className="p-6 flex gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <h3 className="font-serif text-xl font-semibold mb-3 group-hover:text-primary/80 transition-colors">
                          {article.title}
                        </h3>
                        {article.description && (
                          <div className="text-muted-foreground">
            ...
            <div className="lg:sticky lg:top-8 space-y-8">
              ...
              <Card className="p-6">
                <div className="flex items-center space-x-2 pb-4 mb-6 border-b border-border">
                  ...
                  <h2 className="font-serif text-xl font-bold">Trending in {categoryTitle}</h2>
                </div>
                  ...
                  {trendingArticles.map((article, i) => (
                    ...
                    >
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-serif font-medium leading-snug mb-2 group-hover:text-primary/80 transition-colors line-clamp-2">
                            {article.title}
                          </h3>
